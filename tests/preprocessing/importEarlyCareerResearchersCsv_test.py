...
from peerscout.preprocessing import importEarlyCareerResearchersCsv as \
    import_early_career_researchers_csv_module
from peerscout.preprocessing.importEarlyCareerResearchersCsv import (
...
class TestMain:
    def test_should_pass_around_values(self):
        ...
        with patch.object(m, 'connect_managed_configured_database') as \
            ...
            with patch.object(m, 'find_file_to_import') as \
                    find_file_to_import_mock:
