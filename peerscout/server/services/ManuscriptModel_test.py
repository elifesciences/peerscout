  ...
  class TestIsValidManuscript:
    ...
    def test_should_return_manuscript_version_id_with_matching_decision_and_type(self):
      ...
      with create_manuscript_model(dataset) as manuscript_model:
        assert manuscript_model.get_valid_manuscript_version_ids() == {MANUSCRIPT_VERSION_ID1}
    ...
    def test_should_return_manuscript_version_id_with_none_decision_and_none_published_flag(self):
      manuscript_version = {
        **VALID_MANUSCRIPT_VERSION,
        'decision': None,
        'is_published': None
